...
public class KakaoPayServiceImpl implements KakaoPay {
	...
	public String kakaoPayReady() {
		...
		params.add("item_name", "KFLIX 이용권"); // 상품명, 최대 100자
		params.add("quantity", "1"); // 상품 수량
		params.add("total_amount", "7500"); // 상품 총액
		params.add("tax_free_amount", "750"); // 상품 비과세 금액
		...
		try {
			kakaoPayVO = restTemplate.postForObject(new URI(HOST + "/v1/payment/ready"), body, kakaoPayVO.getClass());
